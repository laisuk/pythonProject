...
t2s_radiobutton = tk.Radiobutton(
    config_labelframe, text="Hant (繁体) to Hans (简体)", padx=20, pady=5, value="t2s", variable=config_option)
s2t_radiobutton = tk.Radiobutton(
    config_labelframe, text="Hans (简体) to hant (繁体)", padx=20, pady=5, value="s2t", variable=config_option)
...
source_labelframe.grid(row=0, column=0, sticky="news", padx=10, columnspan=2)
destination_labelframe.grid(row=0, column=2, sticky="news", padx=10, columnspan=2)
...
source_texbox = tk.Text(content_labelframe, width=50, height=30)
source_texbox.grid(row=1, column=0, padx=10, pady=5)
source_scrollbar = tk.Scrollbar(
    content_labelframe, command=source_texbox.yview)
source_scrollbar.grid(row=1, column=1, sticky="news")
source_texbox['yscrollcommand'] = source_scrollbar.set

destination_textbox = tk.Text(content_labelframe, width=50, height=30)
destination_textbox.grid(row=1, column=2, padx=10, pady=5)
destination_scrollbar = tk.Scrollbar(
    content_labelframe, command=destination_textbox.yview)
destination_scrollbar.grid(row=1, column=3, sticky="news")
...
convert_button.grid(row=0, column=0, padx=345, pady=5)
